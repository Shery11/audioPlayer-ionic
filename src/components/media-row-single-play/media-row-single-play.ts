...
/**
 * Generated class for the MediaRowSinglePlayComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'media-row-single-play',
  templateUrl: 'media-row-single-play.html'
})
export class MediaRowSinglePlayComponent {
